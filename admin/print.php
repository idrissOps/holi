...
@page { margin: 0; }
	...
	while($row=mysqli_fetch_array($re))
	{
		...
		$days = $row['noofdays'];
									...
									}else if($meal=="Demi-repas")
									{
										$type_of_meal=$type_of_bed * 3;
									
									}else if($meal=="Repas complet")
									{
	...
	?>
		<header>
			...
			<address >
				...
				<p>Route du golf No 1,<br>Lubumbashi<br>Drc.</p>
				<p>243 904751646</p>
			</address>
			...
			<table class="inventory">
				<thead>
					<tr>
						...
						<th><span >Cout unitaire</span></th>
						<th><span >No de la chambre</span></th>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- contact@HolidayINN.com || Web :- localhost/hotel || Phone :- +243 904751646 </p>
			</div>
		</aside>
	</body>
</html>
